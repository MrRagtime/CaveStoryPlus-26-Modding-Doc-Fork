-- トロ子
local function ActNpc370(npc)
	local rcLeft = {
		{left =   0, top =  64, right =  16, bottom =  80}, --停止
		{left =  16, top =  64, right =  32, bottom =  80},

		{left =  32, top =  64, right =  48, bottom =  80},
		{left =  16, top =  64, right =  32, bottom =  80},
		{left =  48, top =  64, right =  64, bottom =  80},
		{left =  16, top =  64, right =  32, bottom =  80},

		{left = 112, top =  64, right = 128, bottom =  80}, --6ふっとび
		{left = 128, top =  64, right = 144, bottom =  80}, --7つぶれ
	}

	local rcRight = {
		{left =   0, top =  80, right =  16, bottom =  96}, --停止
		{left =  16, top =  80, right =  32, bottom =  96},

		{left =  32, top =  80, right =  48, bottom =  96},
		{left =  16, top =  80, right =  32, bottom =  96},
		{left =  48, top =  80, right =  64, bottom =  96},
		{left =  16, top =  80, right =  32, bottom =  96},

		{left = 112, top =  80, right = 128, bottom =  96}, --6ふっとび
		{left = 128, top =  80, right = 144, bottom =  96}, --7つぶれ
	}
