...
--I think these are for only the Booster 0.8, & 2.0 but I could be wrong... So far each change effects the Boosters though. - Dr. Ragtime

	--Play Testing were done with the Booster 2.0, not the 0.8! - Dr. Ragtime



local function ActCaret07(crt)
